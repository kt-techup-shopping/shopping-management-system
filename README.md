...
| 타입    | 이모지                    | 설명                |
|-------|------------------------|-------------------|
| 초기세팅  | :tada:`:tada:`         | 프로젝트 초기화          |
| 새 기능  | :sparkles:`:sparkles:` | 새로운 기능 추가         |
| 버그 수정 | :bug:`:bug:`           | 버그 수정             |
| 리팩터링  | :recycle:`:recycle:`   | 코드 개선 및 리팩터링      |
| 위치 변경 | :truck:`:truck:`       | 리소스 이동, 이름 변경     |
| 코드 파일 | :fire:`:fire:`         | 코드/파일 삭제          |
| 구성 파일 | :wrench:`:wrench:`     | 구성 파일 추가/삭제       |
| 문서    | :memo:`:memo:`         | 문서 수정 (README 등)  |
| 배포    | :rocket:`:rocket:`     | 배포 관련 작업 또는 빌드 설정 |
